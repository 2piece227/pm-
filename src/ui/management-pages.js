...
export function renderGyms(game,selectedId=null){
  ...
  const canChallenge=!!selected?.party.length&&!game.pendingStarter&&!pwtBreak(game);
  return `<div class="page-h"><h2>체육관 순회</h2><span class="muted">관장 도전은 하루 일정 전체를 사용합니다</span></div><p class="muted">센터에서 준비한 뒤 도전하며, 하루 진행 후 관전이 자동으로 열립니다. 관동은 FRLG, 성도는 HGSS 첫 도전 파티입니다. 한 지방 배지 8개를 모으면 프로 콜업을 결정할 수 있습니다. 유스 정원은 3명입니다.</p>
